        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600 dark:text-neutral-300 max-w-3xl mx-auto">
              Collaborating with leading institutions and organizations to deliver excellence
            </p>
          </div>
          
          <div className="relative overflow-hidden">
            <div className="flex animate-infinite-scroll gap-20 w-max">
              {/* First set of partner images */}
              <div className="flex gap-20 items-center">
                <img 
                  src="/src/assets/Cambridge.jpg" 
                  alt="Cambridge University" 
                  className="h-16 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity duration-300 filter grayscale hover:grayscale-0"
                />
                <img 
                  src="/src/assets/EFL.jpg" 
                  alt="EFL Foundation" 
                  className="h-16 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity duration-300 filter grayscale hover:grayscale-0"
                />
                <img 
