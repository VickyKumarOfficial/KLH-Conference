...
export default function AboutSection() {
  return (
    <section id="about" className="relative py-20 bg-neutral-50 dark:bg-neutral-900/50 overflow-hidden transition-colors duration-300">
      <BackgroundBeams className="opacity-10 dark:opacity-10" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="absolute inset-0 bg-primary/5 dark:bg-primary/10 rounded-lg"></div>
              <p className="relative z-10 py-6 text-lg md:text-xl text-neutral-700 dark:text-neutral-200 leading-relaxed font-medium">
            ...
            <motion.div
              className="h-px bg-primary/30 my-10 mx-auto w-3/4"
              initial={{ scaleX: 0 }}
        ...
        >
          <div className="max-w-4xl mx-auto px-4">
            <h3 className="text-2xl font-bold text-center text-neutral-800 dark:text-white mb-8">
        ...
        >
          ...
          <div className="max-w-4xl mx-auto space-y-4 px-4">
            {aboutData.objectives.map((objective, index) => (
              <motion.div
                key={index}
                className="bg-white dark:bg-neutral-800 p-5 rounded-lg border border-neutral-200 dark:border-neutral-700 hover:border-primary/30 transition-colors duration-300"
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-primary/10 dark:bg-primary/20 rounded-full flex items-center justify-center mt-0.5">
        ...
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl md:text-3xl font-bold text-neutral-800 dark:text-white mb-3">
              Who Should <span className="text-primary">Attend</span>
            </h3>
            <p className="text-neutral-600 dark:text-neutral-300 max-w-2xl mx-auto px-4">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-5 px-4">
            {attendeeCategories.map((category, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  className="bg-white dark:bg-neutral-800 p-6 rounded-lg border border-neutral-200 dark:border-neutral-700 hover:border-primary/30 transition-colors duration-300"
                  initial={{ opacity: 0, y: 10 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-neutral-800 dark:text-white text-base mb-2">
                        {category.title}
                      </h4>
                      ...
                      <div className="space-y-1">
                        <h5 className="font-medium text-primary text-xs">What You'll Gain:</h5>
                        <ul className="space-y-1">
                          {category.benefits.map((benefit, idx) => (
                            <li key={idx} className="text-neutral-600 dark:text-neutral-400 text-xs flex items-center gap-1.5">
